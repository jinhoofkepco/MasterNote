    ...
    MaterialTheme {
        Column(Modifier.fillMaxSize().padding(24.dp)) {
            ...
            Row(Modifier.fillMaxWidth().padding(vertical = 16.dp), horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                ...
                Button(onClick = { com.studyink.library.LibraryTeacherAccess.isValid={TeacherSession.controller.isValid()};context.startActivity(com.studyink.library.LibraryActivity.teacherIntent(context)) }) { Text("책장 관리") }
